...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="views/admin/style.css" media="screen" />
    </head>
    <body>
        ...
        <div id="containerPage">
            <jsp:include page="../../components/buttonAdmin/buttonAdmin.jsp">
                ...
                <jsp:param name="href" value="/views/cadUsuario/index.jsp" />
             </jsp:include>
            <jsp:include page="../../components/cardAdmin/cardAdmin.jsp">
                ...
                <jsp:param name="texto" value="With supporting text below as a natural lead-in to additional content." />
                <jsp:param name="href" value="/views/cadConta/index.jsp" />
             </jsp:include>
        </div>
    </body>
</html>
